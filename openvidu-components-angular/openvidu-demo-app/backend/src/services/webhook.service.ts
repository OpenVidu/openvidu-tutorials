...
import { DEMO_APP_S3_PARENT_DIRECTORY, DEMO_APP_S3_RECORDING_DIRECTORY, LIVEKIT_API_KEY, LIVEKIT_API_SECRET } from '../config.js';
...
export class WebhookService {
	...
	private generateMetadataPath(payload: RecordingInfo): string {
		...
		return `${DEMO_APP_S3_PARENT_DIRECTORY}/${DEMO_APP_S3_RECORDING_DIRECTORY}/.metadata/${metadataFilename}/${recordingFilename}_${egressId}.json`;
	}
}
