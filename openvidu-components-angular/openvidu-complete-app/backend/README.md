# OpenVidu Complete App Backend

This is the backend of OpenVidu Complete App backend. It is a Node.js application that uses [Express](https://expressjs.com/) as web server.
